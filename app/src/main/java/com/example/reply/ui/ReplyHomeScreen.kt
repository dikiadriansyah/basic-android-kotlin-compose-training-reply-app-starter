...
fun ReplyHomeScreen(
    ...
    if(navigationType == WindowStateUtils.PERMANENT_NAVIGATION_DRAWER && replyUiState.isShowingHomepage){
        ...
        if(replyUiState.isShowingHomepage){
            ...
            ReplyDetailsScreen(
                replyUiState = replyUiState,
//            Objek replyUiState adalah objek status
...
//        val navigationRailContentDescription = stringResource(R.string.navigation_rail)
        ...
        Column(
            ...
            if(contentType == ReplyContentType.LIST_AND_DETAIL){
                ...
                AnimatedVisibility(visible = navigationType == WindowStateUtils.BOTTOM_NAVIGATION) {
